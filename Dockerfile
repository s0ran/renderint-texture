...
WORKDIR /src
RUN apt-get update && apt-get install -y cmake make g++ libx11-dev libxi-dev libgl1-mesa-dev libglu1-mesa-dev libxrandr-dev libxext-dev libxinerama-dev libxcursor-dev
COPY . /src/
